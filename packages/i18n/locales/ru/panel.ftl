...
field-add-item = Добавить запись
field-item-placeholder = Новая запись
field-seconds = сек.
field-minutes = мин.
field-hours = ч.
field-days = дн.
field-messages = сообщений
...
setting-warn-punishment-hours = Срок наказания, часов
setting-warn-lifetime-days = Предупреждение сгорает через, дней
setting-stop-words = Стоп-слова
setting-stop-word-presets = Готовые списки
setting-stop-word-action = При стоп-слове
setting-stop-word-mute-hours = Срок мута, часов
...
setting-anti-flood-seconds = …за, секунд
setting-anti-flood-mute-minutes = Срок мута, минут
setting-anti-flood-media-messages = Медиа можно
setting-anti-flood-media-seconds = …за, секунд
...
setting-captcha-timeout-minutes = Время на ответ, минут
...
setting-greeting-delete-after-minutes = Удалять приветствие через, минут
...
setting-autoban-min-account-age-days = Минимальный возраст аккаунта, дней
...
setting-anti-raid-seconds = …за, секунд
setting-anti-raid-lockdown-minutes = Длительность блокировки, минут
...
setting-report-hour-utc = Отправлять в, час UTC
...
setting-reputation-cooldown-seconds = Пауза между очками, секунд
...
setting-min-text-length = Минимальная длина для проверки, символов
